...
{
    public class Publications1Controller : Controller
    {
        private readonly ApplicationContext _context;

        public Publications1Controller(ApplicationContext context)
        {
            _context = context;
        }
